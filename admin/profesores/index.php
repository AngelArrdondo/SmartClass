...
<head>
    ...
    <title>Gestión de Profesores | SmartClass</title>
        ...
        <main class="container-fluid p-4">
            ...
            <?php if(isset($_GET['msg'])): ?>
                <div class="alert alert-success alert-dismissible fade show border-0 shadow-sm mb-4" role="alert">
                    ...
                    <?php 
                        if($_GET['msg'] == 'creado') echo "¡Profesor registrado con éxito!";
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="buscador" class="form-control bg-light border-0" placeholder="Nombre, código o especialidad...">
                            </div>
                        </div>
                        ...
                        <tbody id="tablaProfesores">
                            ...
                            <tr class="<?php echo $opacity_class; ?>">
                                ...
                                <td class="text-end pe-4">
                                    <a href="form.php?id=<?php echo $row['profe_id']; ?>" class="btn btn-sm btn-outline-primary rounded-circle" title="Editar">
...
<script>
    ...
    // Buscador en Tiempo Real igual que en Alumnos
